        ...
        >
          ...
          >
            <div className="flex-1 w-full cursor-pointer">
              <div
                className={`flex bg-white py-8 px-8 justify-between rounded-md items-start w-full ${
              ...
              >
                ...
                <div className={`transition-[6s] text-black`}>
                  <IoMdArrowDropdown
              ...
              >
                <p className="font-normal text-xl bg-white text-[#0A2540] p-8 ">
